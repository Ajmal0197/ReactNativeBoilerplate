...
const TextInputPinkWhiteComp = ({ text, onChangeText, placeholder, containerStyle }) => {
...
export const TextInputPinkWhite = memo(TextInputPinkWhiteComp)
